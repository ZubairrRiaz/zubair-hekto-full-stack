...
//   description: string;
//   buttonText: string;
//   featuredProdcutsTitle: string;
//   latestProductsTitle: string;
//   offerTitle:string,
//   offerDescription:string,
//   uniqueFeaturesTitle:string,
//   uniqueFeaturesDescription:string,
//   trendingProductsTitle:string,
//   discountItemTitle:string,
...
//     <div>
//    {data.map((sanity:any, index:number) => {
...
//             <Link href={"/Product"}>{sanity.buttonText}</Link>
//           </button>
//         </div>
...
//               <p>
//                 $42.00{" "}
//                 <span className="line-through text-green-600">$65.00</span>
//               </p>
//             </div>
//           </div>
...
//             {sanity.uniqueFeaturesTitle}
//           </h1>
//           <p className="text-gray-500 py-3">
//             {sanity.uniqueFeaturesDescription}
//           </p>
